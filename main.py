...
def main():
    start = input("Вы хотите осуществить поиск по вакансиям с ресурса HeadHunter или у вас уже есть файл с "
    ...
    key_top_vac = input("Введите количество вакансий для отображения (топ по зарплате)\n")
